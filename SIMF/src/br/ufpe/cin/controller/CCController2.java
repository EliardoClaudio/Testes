...
/**
 * This class implements a CC2 controller
 * 
 * @author Eliardo Cláudio
 *
 */
public class CCController2 {
    ...
    public CCController2(MySshConnector sshConnection, RandomVariateGenerator failure, RandomVariateGenerator repair) {
    ...
    /**
     * Generates a Random Number (double) aCC2ording to the distribution
     * provided.
     * 
     ...
     * 
     * @return true if the CC2 is running, otherwise returns false
     */
	...
	//System.out.println("entrou no metodo isAlive do CC2 e retornou: " + aux);
	...
	//WriteFile.logger("service eucalyptus-CC2 stop" , "Node_log.txt");
     ...
     * 
     */
    public void startCC2() {
	//FIXME - REIMPLEMENTAR vendo a dependencia!!
	this.getSshConnection().setCommand("service eucalyptus-nc start");
	//WriteFile.logger("service eucalyptus-CC2 start" , "Node_log.txt");
	this.getSshConnection().sshCommand();
    }
     ...
     */
    public void runNCStateMachine2() throws InterruptedException {
